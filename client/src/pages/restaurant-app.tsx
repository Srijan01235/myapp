...
import { ShoppingCart, Plus, Minus, Clock, CheckCircle, AlertCircle, DollarSign, Users, TrendingUp, Edit2, Trash2, Save, X, Settings, LogOut } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gray-50 p-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-2">
              <span className="text-sm text-gray-600 px-3 py-2 bg-white rounded-lg">
